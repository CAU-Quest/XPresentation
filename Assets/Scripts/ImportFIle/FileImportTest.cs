...
public class FileImportTest : MonoBehaviour
{
	...
	IEnumerator ShowLoadDialogCoroutine()
	{
		...
		if( FileBrowser.Success )
		{
			...
			_rawImage.rectTransform.sizeDelta = new Vector2(imageSize.width, imageSize.height);
			
			_rawImage.texture = loadedTexture;
			*/
